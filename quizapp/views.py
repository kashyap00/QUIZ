...
def questionmaker(request):
    if request.method  =="POST":
        ...
        questionmaker = Questionmaker(firstname=firstname,lastname=lastname, email=email, address1= address1,address2=address2 ,state= state, city=city ,zipc=zipc,date=datetime.today())
        questionmaker.save()
